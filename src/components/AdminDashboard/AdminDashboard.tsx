...
export function ShellPage() {
  ...
  const handleBubbleClick = () => {
    const audio = new Audio(process.env.PUBLIC_URL + '/bubble-pop.mp3');
    audio.play();
    setPopMessage('I know I’m far, but I still want to give you at least something, and because all i been working on is this, I thought it be funny. I know it’s a little dumb project and we r not doing so good right now, but Happy Valentine’s Linda, if you haven’t heard it already. I hope this little virtual shell and bubble can make you smile. I love you.');
    setShowShell(false);
